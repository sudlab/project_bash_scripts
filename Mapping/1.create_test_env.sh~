...
# Create config files
cd $DATA_DIR
python ~/dev/CGATPipelines/CGATPipelines/pipeline_mapping.py config > /dev/null
...
echo "cd $DATA_DIR"
echo "python /home/mbp15ja/dev/CGATPipelines/CGATPipelines/pipeline_mapping.py make full -v7 -p8"
